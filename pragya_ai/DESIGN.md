...
*   **Glassmorphism:** Navigation rails should feel like suspended sheets of glass. 
    *   *Tokens:* `surface_container_lowest` (Alpha 0.6) + Backdrop Blur: 12px.
...
*Director's Note: This design system succeeds when the interface feels like it's "breathing." Every element must have a reason to exist. If a border doesn't add clarity, remove it. Let the typography and the tonal shifts do the work.*