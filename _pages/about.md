...
<p>
  IPA – <b>/praːgjaː/</b>&nbsp;
  <span class="audio-icon" style="cursor: pointer" onclick="document.getElementById('pronounce-audio').play()">🔊</span>
  <audio id="pronounce-audio" src="/assets/audio/pragya.mp3" preload="auto"></audio>
</p>
